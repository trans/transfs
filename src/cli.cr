...
# binary is self-contained. The schema is the contract both this CLI and a future
# GUI consume (docs/architecture.md §7); Jargon owns syntax, transfs owns semantic
# resolution (<id>/query -> document).
module TransFS
  class CLI
